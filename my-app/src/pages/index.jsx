  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="text-right fixed top-2 md:top-10 right-1 md:right-3 z-20">
      ...
      <div id="mapSection" className="bg-gradient-to-bl from-[#0d1d24] via-[#142329] to-[#0d1d24] md:px-10 h-screen z-20">
