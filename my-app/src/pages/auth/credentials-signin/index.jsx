  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h6 className="text-center text-secondary text-md font-semibold text-gray-900">
          Marine Debris Reporting Platform
        </h6>

        <div className="shadow-lg mt-8 p-6 rounded-md">
          <h3 className="text-center text-xl text-primary font-bold leading-9 tracking-tight text-gray-900">
